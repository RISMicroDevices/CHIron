...
namespace CCHI {
    ...
    namespace ComponentType {
        inline constexpr ComponentTypeEnumBack Unknown  ("Unknown", 0, "Unknown"                , 0, 0, 0, 0, 0, 0, 0, false, false, false, false, false, false, false);
        ...
        inline constexpr ComponentTypeEnumBack HOME     ("Home"  , 6, "Home"                    , 1, 6, 2, 3, 1, 1, 2, true , true , true , true , true , true , true );
    }

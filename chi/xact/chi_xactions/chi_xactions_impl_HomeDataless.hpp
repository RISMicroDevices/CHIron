...
namespace /*CHI::*/Xact {
    ...
    template<FlitConfigurationConcept       config,
             CHI::IOLevelConnectionConcept  conn>
    inline const FiredResponseFlit<config, conn>* XactionHomeDataless<config, conn>::GetDWTSrcIDSource(const Global<config, conn>& glbl) const noexcept
    {
        return nullptr;
    }
    ...
    template<FlitConfigurationConcept       config,
             CHI::IOLevelConnectionConcept  conn>
    inline const FiredResponseFlit<config, conn>* XactionHomeDataless<config, conn>::GetDWTTgtIDSource(const Global<config, conn>& glbl) const noexcept
    {
        return nullptr;
    }

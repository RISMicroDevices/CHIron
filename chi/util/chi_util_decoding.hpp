...
*/
    ...
    namespace Opcodes {
        ...
        */
        ...
        class DecoderBase {
        protected:
            static constexpr size_t     OPCODE_SLOT_COUNT = _Tflit::OPCODE_WIDTH << 1;
        ...
        public:
            ...
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                Decode(typename _Tflit::opcode_t opcode) const noexcept;
        ...
        public:
            ...
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                DecodeRNF(typename _Tflit::opcode_t opcode) const noexcept;

            /*
            Opcode decode for RN-D
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                DecodeRND(typename _Tflit::opcode_t opcode) const noexcept;

            /*
            Opcode decode for RN-I
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                DecodeRNI(typename _Tflit::opcode_t opcode) const noexcept;

            /*
            Opcode decode for HN-F
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                DecodeHNF(typename _Tflit::opcode_t opcode) const noexcept;

            /*
            Opcode decode for HN-I
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                DecodeHNI(typename _Tflit::opcode_t opcode) const noexcept;

            /*
            Opcode decode for SN-F
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                DecodeSNF(typename _Tflit::opcode_t opcode) const noexcept;

            /*
            Opcode decode for SN-I
            */
            virtual const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>&
                DecodeSNI(typename _Tflit::opcode_t opcode) const noexcept;
...
*/
    namespace Opcodes {
        ...
        */
        ...
        {
            const OpcodeInfo<typename _Tflit::opcode_t, _Tcompanion>& info 
                = opcodes[opcode];
...
*/
    namespace Opcodes::REQ {
        ...
        #define OPCODE_INFO_SET(name) \
            this->opcodes[name] \
                = OpcodeInfo<_Tflit, _Tcompanion>(OpcodeInfo<_Tflit, _Tcompanion>::Channel::REQ, \
                name, #name)

        #define OPCODE_MASK_SET(target, name) \
            this->mask_##target[name].set()
...
*/
    namespace Opcodes::SNP {
        ...
        #define OPCODE_INFO_SET(name) \
            this->opcodes[name] \
                = OpcodeInfo<_Tflit, _Tcompanion>(OpcodeInfo<_Tflit, _Tcompanion>::Channel::SNP, \
                name, #name)
...
*/
    namespace Opcodes::DAT {
        ...
        #define OPCODE_INFO_SET(name) \
            this->opcodes[name] \
                = OpcodeInfo<_Tflit, _Tcompanion>(OpcodeInfo<_Tflit, _Tcompanion>::Channel::DAT, \
                name, #name)
...
*/
    namespace Opcodes::RSP {
        ...
        #define OPCODE_INFO_SET(name) \
            this->opcodes[name] \
                = OpcodeInfo<_Tflit, _Tcompanion>(OpcodeInfo<_Tflit, _Tcompanion>::Channel::RSP, \
                name, #name)
